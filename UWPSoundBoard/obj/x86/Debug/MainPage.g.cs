#pragma checksum "C:\Users\Luong doan\source\repos\UWP\UWPSoundBoard\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "8A7EA3BB1E358AA24309F1DC205CCC25"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace UWPSoundBoard
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj5_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWPSoundBoard.Models.MenuItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::UWPSoundBoard.Models.MenuItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWPSoundBoard.Models.MenuItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::UWPSoundBoard.Models.MenuItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Category(global::UWPSoundBoard.Models.SoundCategory obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj12_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWPSoundBoard.Models.Sound dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::UWPSoundBoard.Models.Sound) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWPSoundBoard.Models.Sound)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::UWPSoundBoard.Models.Sound obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 24 && columnNumber == 78)
                {
                    isobj3ItemsSourceDisabled = true;
                }
                else if (lineNumber == 43 && columnNumber == 189)
                {
            ...
            private void Update_MenuItems(global::System.Collections.Generic.List<global::UWPSoundBoard.Models.MenuItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Sounds(global::System.Collections.ObjectModel.ObservableCollection<global::UWPSoundBoard.Models.Sound> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
